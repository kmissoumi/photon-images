...
public class DesktopTests extends SauceBaseTest {
    ...
    protected static final String BUILD_NAME = "Java Best Practice Demo" + " " + System.getenv().getOrDefault("SAUCE_BUILD_TYPE", "Local") + " " + System.getenv().getOrDefault("GITHUB_RUN_NUMBER", String.valueOf(System.currentTimeMillis()));
